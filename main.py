...
"""
Модуль для тренировки персонажей игры.
"""


def attack(char_name: str, char_class: str) -> str:
    """
    Атакует противника в зависимости от класса персонажа.
...
def defence(char_name: str, char_class: str) -> str:
    ...
    return (f'{char_name} не заблокировал ед. урона')


def special(char_name: str, char_class: str) -> str:
    """
    Применяет способности персонажа.
...
def start_training(char_name: str, char_class: str) -> str:
    ...
    Returns:
        str: Строка с сообщением о завершении тренировки.
    """
    if char_class == 'warrior':
